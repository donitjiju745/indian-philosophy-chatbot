...
async def startup_event():
    ...
    logger.info("=" * 60)
    logger.info("🕉️  INDIAN PHILOSOPHY CHATBOT - BACKEND STARTUP")
    logger.info("=" * 60)
    logger.info(f"Knowledge Base Loaded: {len(INDIAN_PHILOSOPHY_KB)} questions")
...
async def shutdown_event():
    """Cleanup on shutdown"""
    logger.info("Indian Philosophy Chatbot - Backend shutting down")
